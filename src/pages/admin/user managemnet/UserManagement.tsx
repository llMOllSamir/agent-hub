...
export default function UserManagement() {
  ...
  return (
    <section className='grid grid-cols-1'>
      <form onSubmit={formik.handleSubmit} className='  grid  md:grid-cols-2 gap-10 gap-y-4 ' >
        <div className='border-b border-yellow-700  grid grid-cols-1 py-5 gap-4'>
          <h2 className='text-xl font-bold   text-blue-800 underline underline-offset-8 '>Personal Details</h2>
        ...
        <div className='grid grid-cols-1 py-5 gap-4'>
          <h2 className='text-xl font-bold   text-blue-800 underline underline-offset-8 mb-3 '>Stuff Role Access</h2>
          {
        ...
        <div className='grid grid-cols-1 gap-4 py-5'>
          <h2 className='text-xl font-bold   text-blue-800 underline underline-offset-8   '>Confirmation</h2>
          ...
          <button type='submit' className='rounded-xl cursor-pointer w-40 px-5 h-fit py-2 bg-blue-700 text-white font-bold flex justify-center items-center ms-auto'>Confirm</button>
        </div>
      </form>
    </section>
  )
